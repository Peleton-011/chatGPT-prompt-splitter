...
function formatLanguage(language) {
	return `
    {
        ...
        "native": "${language[1].nativeName}",
    },`;
}

function formatLanguages(languageList) {
	return languageList.map((language) => formatLanguage(language)).join("\n");
}

const languageList = Object.entries(languages);

console.log(formatLanguages(languageList));
